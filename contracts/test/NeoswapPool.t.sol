...
contract NeoswapPoolTest is Test, TestUtils {
    ...
    function testSwapBuyEth() public {
        ...
        NeoswapPool.CallbackData memory extra = NeoswapPool.CallbackData({
    ...
    function uniswapV3SwapCallback(
        ...
        if (transferInSwapCallback) {
            NeoswapPool.CallbackData memory extra = abi.decode(
                data,
    ...
    function setupTestCase(TestCaseParams memory params) internal returns (uint256 poolBalance0, uint256 poolBalance1) {
        ...
        if (params.mintLiqudity) {
            ...
            NeoswapPool.CallbackData memory extra = NeoswapPool
                .CallbackData({
                    token0: address(token0),
                    token1: address(token1),
                    payer: address(this)
